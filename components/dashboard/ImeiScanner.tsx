    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
          ...
          <button onClick={onClose} style={{ background: 'rgba(255,255,255,0.1)', border: 'none', borderRadius: 50, padding: '0.4rem', color: '#fff', cursor: 'pointer' }}>
            <X size={20} />
          </button>
        </div>
        ...
        <div style={{ position: 'relative', width: '100%', height: 320, borderRadius: 18, background: '#111', overflow: 'hidden', border: '2px solid rgba(14,165,233,0.15)' }}>
          {hasCamera ? (
            ...
            <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: 'rgba(255,255,255,0.5)', gap: '0.5rem' }}>
              <CameraOff size={32} />
        ...
        <div style={{ marginTop: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          ...
          <button
            onClick={mockScan}
            style={{
              padding: '1rem', background: '#0ea5e9', color: '#fff', borderRadius: 14,
