  ...
  return (
    <header
      style={{
        ...
        boxShadow: scrolled ? '0 4px 24px rgba(6,182,212,0.08)' : '0 1px 3px rgba(0,0,0,0.06)',
      }}
    >
      {/*
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ fontWeight: 200, color: '#94A3B8', letterSpacing: '0.25em', marginLeft: '2px' }}>ERP</span>
          </div>
        </div>
