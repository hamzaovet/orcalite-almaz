...
export default function SettingsPage() {
  ...
  const inp: React.CSSProperties = {
    ...
    borderRadius: 12, fontSize: '0.92rem', fontFamily: 'inherit', color: '#FFFFFF',
    outline: 'none', background: 'rgba(6, 182, 212, 0.05)', boxSizing: 'border-box'
  }
  const lbl: React.CSSProperties = {
    fontSize: '0.82rem', fontWeight: 700, color: '#94A3B8', display: 'block', marginBottom: '0.5rem',
  }

  return (
    <div style={{ maxWidth: 900, margin: '0 auto', color: '#F8FAFC' }}>
      ...
      <div style={{ marginBottom: '3rem' }}>
        ...
        <h1 style={{ fontSize: '2.4rem', fontWeight: 900, color: '#FFFFFF' }}>إعدادات المتجر</h1>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
        ...
        <div style={card}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
            ...
            <div>
              <h2 style={{ fontWeight: 900, fontSize: '1.25rem', color: '#FFFFFF' }}>إعدادات الهوية والتواصل</h2>
              <p style={{ fontSize: '0.82rem', color: '#64748B' }}>تخصيص الفواتير وتفاصيل متجرك</p>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginBottom: '1.5rem' }}>
            ...
            <div style={{ gridColumn: '1 / -1' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', background: 'rgba(6,182,212,0.05)', padding: '1rem', borderRadius: 12, border: '1px solid rgba(6,182,212,0.15)' }}>
                {storeSettings.storeLogoUrl ? (
                  ...
                  <div style={{ width: 60, height: 60, borderRadius: 10, background: 'rgba(6,182,212,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#06B6D4' }}>
                    <Upload size={24} />
                  </div>
                )}
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
                    <label style={{ cursor: 'pointer', background: '#06B6D4', color: '#fff', padding: '0.5rem 1rem', borderRadius: 8, fontSize: '0.85rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  ...
                  <p style={{ margin: 0, marginTop: '0.5rem', fontSize: '0.75rem', color: '#64748B' }}>يدعم JPG, PNG. يتم الرفع مباشرة لخوادم ImgBB واستخراج الرابط تلقائياً.</p>
                </div>
              </div>
            </div>
            ...
            <div style={{ gridColumn: '1 / -1', borderTop: '1px solid rgba(6,182,212,0.1)', paddingTop: '1.5rem', marginTop: '0.5rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', marginBottom: '1.25rem' }}>
                ...
                <h3 style={{ fontSize: '1rem', fontWeight: 900, color: '#FFFFFF' }}>توجيه الرسائل (Smart Routing)</h3>
              </div>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                <div>
                  ...
                  <p style={{ marginTop: '0.4rem', fontSize: '0.7rem', color: '#64748B' }}>لحجز الأجهزة، شراء الأجهزة المستعملة، والاستفسارات العامة.</p>
                </div>
                <div>
                  ...
                  <p style={{ marginTop: '0.4rem', fontSize: '0.7rem', color: '#64748B' }}>لطلبات فحص وتسعير صيانة الأجهزة أونلاين.</p>
                </div>
              </div>
              <p style={{ marginTop: '1rem', fontSize: '0.75rem', color: '#06B6D4', fontWeight: 600, background: 'rgba(6,182,212,0.05)', padding: '0.6rem 1rem', borderRadius: 8 }}>
                💡 ملحوظة: إذا تركت هذه الحقول فارغة، سيتم تحويل كافة الطلبات تلقائياً إلى الرقم الأساسي للمتجر.
              </p>
            </div>
          </div>
          <button onClick={handleSaveSettings} disabled={savingSettings} style={{ background: '#3B82F6', color: '#fff', border: 'none', borderRadius: 12, padding: '0.8rem 2rem', fontWeight: 800, cursor: savingSettings ? 'not-allowed' : 'pointer', fontFamily: 'inherit' }}>
        ...
        <div id="currency-section" style={card}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
            <div style={{ width: 44, height: 44, borderRadius: 14, background: 'rgba(6,182,212,0.1)', border: '1px solid rgba(6,182,212,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Coins size={22} color="#06B6D4" />
            </div>
            <div>
              <h2 style={{ fontWeight: 900, fontSize: '1.25rem', color: '#FFFFFF' }}>إدارة العملات وصرف العملة</h2>
              <p style={{ fontSize: '0.82rem', color: '#64748B' }}>تحديث أسعار صرف السوق لتسعير الجملة التلقائي</p>
            </div>
          </div>

          <div style={{ display: 'grid', gap: '1rem', marginBottom: '2rem' }}>
            {currencies.map(cur => (
              <div key={cur._id} style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', background: 'rgba(255,255,255,0.02)', padding: '1rem', borderRadius: 12, border: '1px solid rgba(255,255,255,0.05)' }}>
                <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  <span style={{ fontWeight: 900, fontSize: '1.1rem', background: 'rgba(6,182,212,0.1)', color: '#06B6D4', padding: '0.4rem 0.8rem', borderRadius: 8 }}>{cur.code}</span>
                  <span style={{ color: '#94A3B8', fontWeight: 600 }}>{cur.name}</span>
                </div>
          ...
          <div style={{ borderTop: '1px solid rgba(6,182,212,0.1)', pt: '1.5rem', display: 'flex', gap: '1rem', alignItems: 'flex-end', paddingTop: '1.5rem' }}>
            ...
            <button onClick={handleAddCurrency} disabled={savingCurrencies} style={{ background: '#06B6D4', color: '#fff', border: 'none', borderRadius: 12, padding: '0.88rem 1.5rem', fontWeight: 800, cursor: 'pointer', height: 'fit-content' }}>
              <Plus size={20} />
            </button>
          </div>
        </div>
        ...
        <div style={card}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
            ...
            <div>
              <h2 style={{ fontWeight: 900, fontSize: '1.25rem', color: '#FFFFFF' }}>تأمين الحساب</h2>
              <p style={{ fontSize: '0.82rem', color: '#64748B' }}>تغيير كلمة المرور الخاصة بالإدارة</p>
            </div>
          </div>
          ...
          <form onSubmit={handlePwSave} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
            <div style={{ gridColumn: '1 / -1' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <button type="button" onClick={() => setShowOld(!showOld)} style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', color: '#64748B', display: 'flex' }}>
            ...
            {[{ label: 'كلمة المرور الجديدة', key: 'new1' }, { label: 'تأكيد كلمة المرور', key: 'new2' }].map((f) => (
              <div key={f.key}>
                ...
                <div style={{ position: 'relative' }}>
                  ...
                  <button type="button" onClick={() => setShowNew(!showNew)} style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', color: '#64748B', display: 'flex' }}>
            ...
            <div style={{ gridColumn: '1 / -1' }}>
              <button type="submit" style={{ background: '#06B6D4', color: '#fff', border: 'none', borderRadius: 14, padding: '0.9rem 2.5rem', fontWeight: 800, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 8px 24px rgba(6,182,212,0.3)' }}>تحديث كلمة المرور</button>
            </div>
          </form>
        </div>
        ...
        <div style={card}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <div>
                <h2 style={{ fontWeight: 900, fontSize: '1.25rem', color: '#FFFFFF' }}>إدارة الصلاحيات</h2>
                <p style={{ fontSize: '0.82rem', color: '#64748B' }}>{users.length} مستخدمين نشطين</p>
              </div>
            </div>
            <button
              onClick={() => setShowAddForm(!showAddForm)}
              style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', background: '#A855F7', color: '#fff', border: 'none', borderRadius: 12, padding: '0.75rem 1.4rem', fontWeight: 800, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 8px 24px rgba(168,85,247,0.3)' }}
            >
            ...
            {showAddForm && (
              <motion.form initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }}
                ...
                <div style={{ display: 'flex', alignItems: 'flex-end', gap: '0.75rem' }}>
                  <button type="submit" style={{ flex: 1, background: '#A855F7', color: '#fff', border: 'none', borderRadius: 12, padding: '0.85rem', fontWeight: 800, cursor: 'pointer' }}>حفظ</button>
                  <button type="button" onClick={() => setShowAddForm(false)} style={{ flex: 1, background: 'rgba(255,255,255,0.05)', color: '#fff', border: 'none', borderRadius: 12, padding: '0.85rem', fontWeight: 700, cursor: 'pointer' }}>إلغاء</button>
                </div>
              </motion.form>
            )}
          </AnimatePresence>
          ...
          <div style={{ display: 'grid', gap: '0.85rem' }}>
            {users.map((u) => (
              <div key={u.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1rem 1.25rem', borderRadius: 16, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', transition: 'all 0.2s' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  ...
                  <div>
                    <p style={{ fontWeight: 800, color: '#FFFFFF' }}>{u.name}</p>
                    <p style={{ fontSize: '0.78rem', color: '#64748B' }}>@{u.username}</p>
                  </div>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
      ...
      <AnimatePresence>
        {showResetModal && (
          <div style={{ position: 'fixed', inset: 0, zIndex: 9999, background: 'rgba(8,12,20,0.85)', display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(10px)', padding: '1rem' }}>
            <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} style={{ background: '#0B1120', borderRadius: 24, border: '1px solid rgba(239,68,68,0.3)', width: '100%', maxWidth: 450, padding: '2rem' }}>
              ...
              <h2 style={{ fontSize: '1.5rem', fontWeight: 900, color: '#fff', textAlign: 'center', marginBottom: '0.5rem' }}>تصفير بيانات المتجر</h2>
              <p style={{ color: '#94A3B8', textAlign: 'center', fontSize: '0.9rem', marginBottom: '2rem', lineHeight: 1.6 }}>
              ...
              <div style={{ display: 'flex', gap: '1rem' }}>
                <button 
                  ...
                  disabled={isWiping}
                  style={{ flex: 1, padding: '1rem', background: 'transparent', border: '1px solid rgba(255,255,255,0.1)', color: '#94A3B8', borderRadius: 12, fontWeight: 700, cursor: 'pointer' }}
                >
                  إلغاء التصفير
                </button>
                <button 
                  ...
                  style={{ flex: 1, padding: '1rem', background: '#EF4444', border: 'none', color: '#fff', borderRadius: 12, fontWeight: 900, cursor: (isWiping || !accountPassword) ? 'not-allowed' : 'pointer', opacity: (isWiping || !accountPassword) ? 0.5 : 1, display: 'flex', justifyContent: 'center', alignItems: 'center' }}
                >
